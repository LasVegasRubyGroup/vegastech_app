...
describe Story do
  ...
  context "When calculating ranking" do
    ...
    it "should have a rank that is 0 with one up vote and one down vote" do
      story.save
      vote1 = Vote.create(story_id: story.id, twitter_handle: "@fredguest", value: 1)
      vote2 = Vote.create(story_id: story.id, twitter_handle: "@dylansimpson", value: -1)
      story.rank.should == 0
    end
    ...
    it "it should have a rank of the sum of the value of it votes" do
      story.save
      FactoryGirl.create(:vote, story: story)
    end
